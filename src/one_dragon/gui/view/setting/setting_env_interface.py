...
from one_dragon.envs.env_config import env_config, RepositoryTypeEnum, GitMethodEnum, ProxyTypeEnum
...
class SettingEnvInterface(VerticalScrollInterface):
    ...
    def __init__(self, parent=None):
        ...
        content_layout.addWidget(git_group, stretch=0)
        ...
        content_layout.addWidget(web_group, stretch=1)
