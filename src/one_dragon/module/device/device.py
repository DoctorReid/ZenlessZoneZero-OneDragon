...
from one_dragon.module.device.pkg_resources import get_distribution

# Just avoid being removed by import optimization
_ = get_distribution

from one_dragon.module.base.timer import Timer
from one_dragon.module.device.app_control import AppControl
from one_dragon.module.device.control import Control
from one_dragon.module.device.screenshot import Screenshot
...
class Device(Screenshot, Control, AppControl):
    ...
    def run_simple_screenshot_benchmark(self):
        ...
        # Perform benchmark
        from one_dragon.module.daemon.benchmark import Benchmark
