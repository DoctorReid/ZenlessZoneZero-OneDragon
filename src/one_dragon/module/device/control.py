from one_dragon.module.base.button import ClickButton
from one_dragon.module.base.decorator import cached_property
from one_dragon.module.base.timer import Timer
from one_dragon.module.base.utils import *
from one_dragon.module.device.method.hermit import Hermit
from one_dragon.module.device.method.maatouch import MaaTouch
from one_dragon.module.device.method.minitouch import Minitouch
...
class Control(Hermit, Minitouch, Scrcpy, MaaTouch, NemuIpc):
    ...
    def clickxy(self,pos: Point = None):
        x,y=pos.tuple()
        logger.info(
    ...
    def long_clickxy(self, pos: Point = None, duration:float=1):
