...
from one_dragon.module.base.button import Button, ButtonWrapper, ClickButton, match_template
...
from one_dragon.module.device.method.utils import HierarchyButton
...
class ModuleBase:
    ...
    def screenshot_tracking_add(self):
        ...
        def image_encode(im, ti):
            import io
            from one_dragon.module.handler.sensitive_info import handle_sensitive_image
