...
from zzz_od.context.property_decorators import property_group, config_property, record_property
...
class ZContext(OneDragonContext):
    ...
    # ========== 空洞（探险） ==========
    @config_property(category="空洞", description="空洞零号配置")
    ...
    @record_property(category="空洞", description="空洞零号运行记录")
    ...
    @config_property(category="空洞", description="空洞挑战配置")
    ...
    # ========== 迷失之地 ==========
    @config_property(category="迷失之地", description="迷失之地配置")
    ...
    # ========== Random Play 录像店 ==========
    @config_property(category="RandomPlay", description="RandomPlay配置")
    ...
    @record_property(category="RandomPlay", description="RandomPlay运行记录")
    ...
    # ========== 体力计划 ==========
    @config_property(category="体力计划", description="体力计划配置")
    ...
    @record_property(category="体力计划", description="体力计划运行记录")
    ...
    # ========== 恶名狩猎 ==========
    @config_property(category="恶名狩猎", description="恶名狩猎配置")
    ...
    @record_property(category="恶名狩猎", description="恶名狩猎运行记录")
    ...
    @record_property(category="咖啡计划", description="咖啡运行记录")
    ...
    @record_property("驱动盘拆解", "驱动盘拆解运行记录")
    ...
    def _clear_cached_configs(self) -> None:
        """清理所有缓存的配置对象"""
        property_group.clear_configs(self)

    def _clear_cached_run_records(self) -> None:
        """清理所有缓存的运行记录对象"""
        property_group.clear_records(self)