...
from qfluentwidgets import (
    FluentIcon, SettingCardGroup, TitleLabel, BodyLabel, PrimaryPushButton,
...
class SourceConfigInterface(VerticalScrollInterface):
    ...
    def get_content_widget(self) -> QWidget:
        ...
        content_widget.v_layout.setSpacing(20)

        # 标题
        title_label = TitleLabel("配置镜像源")
        title_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        content_widget.add_widget(title_label)
        ...
        content_widget.add_widget(description)

        # 代码仓库设置
        self.git_group = SettingCardGroup("代码仓库设置")
        content_widget.add_widget(self.git_group)
        ...
        content_widget.add_widget(self.proxy_group)
        ...
        content_widget.add_widget(self.python_group)
        ...
        content_widget.add_widget(confirm_widget)
