...
from zzz_od.application.battle_assistant.battle_assistant_config import get_dodge_op_by_name
...
class DodgeAssistantApp(ZApplication):
    ...
    def load_op(self) -> OperationRoundResult:
        ...
        config = get_dodge_op_by_name(self.ctx.dodge_assistant_config.dodge_assistant_config)
        if config is None:
